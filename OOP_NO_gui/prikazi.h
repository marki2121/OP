...
void upis(cls::glavna g) {
    ...
    case 1:
        ...
        std::cin >> cijena;
        std::cout << "Unesi rok oblika yyyy-mm-dd: ";
        std::cin >> rok;

        if (rok.size() != 10) { rok = "1998-11-29"; }
...
void testPod(cls::glavna g) {
    g.UpisProizvodaPaket(cls::PaketProizvod("Margo", 64, 9.99, "2022-06-22"));
    ...
    g.UpisProizvaodaKilaza(cls::KilazaProizvod("Jabuka", 1.86, 9.99, "2021-11-29"));
